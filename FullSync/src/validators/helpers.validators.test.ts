...
describe('Validation Helpers', () => {
  ...
  describe('array validator', () => {
    ...
    const [path, validators] = arrayStringValidator(
      ['testArray'],
      {
        code: 'InvalidArray',
    ...
    const validateValue = (value: string | (string | number)[] | (string | null | undefined)[]) => {
      return !validationHelpers.getValidateMessages(
        [[path, validators]],
        { testArray: value }
      ).length;
    };
